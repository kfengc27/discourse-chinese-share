  ...
  initialize: function() {
    ...
    Sharing.addSource({
      ...
      generateUrl: function(link, title) {
        return ("http://service.weibo.com/share/share.php?url=" + encodeURIComponent(link) + "&title=分享了来自 @UNSW学生社区 的话题【" + encodeURIComponent(title))+ "】&searchPic=true&style=number";
      },
